...
func main() {
	...
	url := "https://gateway.snowpal.com/pods/%7B%7Bpods.podId%7D%7D/comments?keyId=%7B%7Bkeys.custom.keyId1%7D%7D"
	method := "POST"

	payload := strings.NewReader(`{"commentText":"new pod com comment[comment_text]"}`)
