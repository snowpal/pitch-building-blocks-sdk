...
func main() {
	...
	url := "https://gateway.snowpal.com/blocks/%7B%7Bblocks.blockId%7D%7D/users/63cabea69e9c500014d4f9b7/share?keyId=%7B%7Bkeys.custom.keyId1%7D%7D"
	method := "PATCH"

	payload := strings.NewReader(`{"blockAcl":"read"}`)
