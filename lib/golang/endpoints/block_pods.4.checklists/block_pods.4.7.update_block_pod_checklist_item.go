...
func main() {
	...
	url := "https://gateway.snowpal.com/block-pods/:id/checklists/:checklist-id/checklist-items/:checklist-item-id?keyId=63ceb29edb035900138d975d&blockId=43bwn23fje782486247d248h"
	method := "PATCH"
