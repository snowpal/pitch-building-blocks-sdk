...
func main() {
	...
	url := "https://gateway.snowpal.com/block-pods/:id/users/:user-id/share?keyId=63ceb29edb035900138d975d&blockId=93bwn23fje782486247d248h"
	method := "PATCH"

	payload := strings.NewReader(`{"podAcl":"assessment[acl]"}`)
